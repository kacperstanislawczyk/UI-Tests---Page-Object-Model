...
public class EmailUtils {
    ...
    public EmailUtils(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
        ...
        try {
            props.load(new FileInputStream(new File("/Users/kstanislawczyk/Projects/kef_social_login/src/main/resources/email.properties")));
        } catch(Exception e) {
            e.printStackTrace();
            System.exit(-1);
        }
     ...
     */
    public List<String> getUrlsFromMessage(Message message) throws Exception{
    ...
    public void deleteAllEmails() {
        try{
            ...
            System.out.println("Error while deleting emails");
            e.printStackTrace();
        }
        ...
        System.out.println("Emails have been deleted.");
